...
type EventName = "email_delivery_failed" | "email_delivery_sent" | "email_retry_unauthorized" | "print_delivery_failed" | "print_delivery_sent" | "print_retry_unauthorized" | "order_create_failed" | "cron_failed";
